...
# Environment
################################################################################
export CONFIG_PATH=/Users/abdelrahmansalem/Sites/abdel-config

if [[ -f $CONFIG_PATH/zsh/env.zsh ]]; then
    source $CONFIG_PATH/zsh/env.zsh
fi
...
export nvm_default_version="v24.4.1"

[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion

export PNPM_HOME="/Users/abdelrahmansalem/Library/pnpm"
